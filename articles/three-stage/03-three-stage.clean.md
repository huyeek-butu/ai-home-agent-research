...
- [引言](#引言)
- [1. 阶段一：软件切入的 AI 数字管家](#1-阶段一软件切入的-ai-数字管家家庭知识中枢采购代理日程协调与数据飞轮)
- [2. 阶段二：家庭 AI 服务器中枢](#2-阶段二家庭-ai-服务器中枢matter-互联边缘本地算力数字孪生与感知-决策-执行闭环)
- [3. 阶段三：具身智能进家庭](#3-阶段三具身智能进家庭分离式架构vla-与灵巧手3a-3b-3c-渐进路线及-affordance-鸿沟)
- [4. 演进路径的底层逻辑](#4-演进路径的底层逻辑技术成熟度错配信任梯度数据飞轮与阶段跃迁瓶颈)
- [5. 终局形态：分离式具身智能与即插即用](#5-终局形态分离式具身智能与即插即用的家庭机器人商业落地规律)
- [结论](#结论)
- [参考文献](#参考文献)
